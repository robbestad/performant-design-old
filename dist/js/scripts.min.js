...
!function(){"use strict"}(),jQuery(function(t){function n(){a.parallax("50%",1)}(setNavbar=function(){t(".navbar ul>li").css("width",t(".content").width()/3-2+"px")})(),t(document).ready(function(){t(".navbar-wrapper").stickUp(),setNavbar()}),t(window).resize(function(){setNavbar()}),t(".modal-event").on("click",function(){console.log(t(this).attr("src")),t(".modal-img").attr("src",t(this).attr("src"))}),t(window).bind("load",function(){n()});var a=jQuery(".masthead");n()});
