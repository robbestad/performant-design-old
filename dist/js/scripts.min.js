...
!function(){"use strict"}(),jQuery(function(n){function t(){a.parallax("50%",1)}(setNavbar=function(){n(".navbar ul>li").css("width",n(".content").width()/3-2+"px")})(),n(document).ready(function(){n(".navbar-wrapper").stickUp(),setNavbar()}),n(window).resize(function(){setNavbar()}),n(".modal-event").on("click",function(){n(".modal-img").attr("src",n(this).attr("src"))}),n(window).bind("load",function(){t()});var a=jQuery(".masthead");t()});
