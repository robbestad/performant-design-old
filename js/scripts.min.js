...
!function(){"use strict"}(),jQuery(function(t){function e(){n.parallax("50%",1)}var o=[self.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft,self.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop];(setNavbar=function(){t(".navbar ul>li").css("width",t(".content").width()/3-2+"px")})(),t(document).ready(function(){t(".navbar-wrapper").stickUp(),setNavbar()}),t(window).resize(function(){setNavbar()}),t(".modal-event").on("click",function(){t(".modal-img").attr("src",t(this).attr("src")),t("html").css("position","fixed"),o=[self.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft,self.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop]}),t(".modal-close").on("click",function(){t("html").css("position","relative"),window.scrollTo(o[0],o[1])}),t(window).bind("load",function(){e()});var n=jQuery(".masthead");e()});
