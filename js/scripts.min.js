...
!function(){"use strict"}(),jQuery(function(o){function t(){e.parallax("50%",1)}var c=[self.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft,self.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop];(setNavbar=function(){o(".navbar ul>li").css("width",o(".content").width()/3-2+"px")})(),o(document).ready(function(){o(".navbar-wrapper").stickUp(),setNavbar()}),o(window).resize(function(){setNavbar()}),o(".modal-event").on("click",function(){o(".modal-img").attr("src",o(this).attr("src")),c=[self.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft,self.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop],o(".masthead").css("opacity",0),o(".row").css("opacity",0),o(".nav").css("opacity",0),o("html").css("position","fixed"),o(".modal-close").css("zIndex","9999")}),o(".modal-close").on("click",function(){o("html").css("position","relative"),window.scrollTo(c[0],c[1]),o("body").css("opacity",1),o(".masthead").css("opacity",1),o(".row").css("opacity",1),o(".nav").css("opacity",1)}),o(window).bind("load",function(){t()});var e=jQuery(".masthead");t()});
