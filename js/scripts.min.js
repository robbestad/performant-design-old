...
!function(){"use strict"}(),jQuery(function(t){function o(){c.parallax("50%",1)}var e=[self.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft,self.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop];(setNavbar=function(){t(".navbar ul>li").css("width",t(".content").width()/3-2+"px")})(),t(document).ready(function(){t(".navbar-wrapper").stickUp(),setNavbar()}),t(window).resize(function(){setNavbar()}),t(".modal-event").on("click",function(){t(".modal-img").attr("src",t(this).attr("src")),e=[self.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft,self.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop],t(".masthead").css("opacity",0),t(".content").css("opacity",0),t("html").css("position","fixed")}),t(".modal-close").on("click",function(){t("html").css("position","relative"),window.scrollTo(e[0],e[1]),t("body").css("opacity",1),t(".masthead").css("opacity",1),t(".content").css("opacity",1)}),t(window).bind("load",function(){o()});var c=jQuery(".masthead");o()});
