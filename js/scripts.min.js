...
jQuery(function(s){s(document).ready(function(){var t=[],o=[],n=0,r="",e="",a="",i=null,c=0,l=0,p=0,u=0;s(window).scroll(function(){var t=s(this).scrollTop();r=t>n?"down":"up",n=t}),s.fn.stickUp=function(t){s(this).addClass("stuckMenu");var n=0;if(null!=t){for(var r in t.parts)t.parts.hasOwnProperty(r)&&(o[n]=t.parts[n],n++);0==n&&console.log("error:needs arguments"),e=t.itemClass,a=t.itemHover,null!=t.topMargin?"auto"==t.topMargin?u=parseInt(s(".stuckMenu").css("margin-top")):isNaN(t.topMargin)&&t.topMargin.search("px")>0?u=parseInt(t.topMargin.replace("px","")):isNaN(parseInt(t.topMargin))?(console.log("incorrect argument, ignored."),u=0):u=parseInt(t.topMargin):u=0,i=s("."+e).size()}c=parseInt(s(this).height()),l=parseInt(s(this).css("margin-bottom")),p=parseInt(s(this).next().closest("div").css("margin-top")),vartop=parseInt(s(this).offset().top)},s(document).on("scroll",function(){function n(n){contentView=.4*s("#"+o[n]).height(),testView=t[n]-contentView,varscroll>testView?(s("."+e).removeClass(a),s("."+e+":eq("+n+")").addClass(a)):50>varscroll&&(s("."+e).removeClass(a),s("."+e+":eq(0)").addClass(a))}if(varscroll=parseInt(s(document).scrollTop()),null!=i)for(var v=0;i>v;v++)t[v]=s("#"+o[v]).offset().top,"down"==r&&varscroll>t[v]-50&&varscroll<t[v]+50&&(s("."+e).removeClass(a),s("."+e+":eq("+v+")").addClass(a)),"up"==r&&n(v);varscroll+u>vartop&&(s(".stuckMenu").addClass("isStuck"),s(".stuckMenu").next().closest("div").css({"margin-top":c+l+p+"px"},10),s(".stuckMenu").css("position","fixed"),s(".isStuck").css({top:"0px"},10,function(){})),vartop>varscroll+u&&(s(".stuckMenu").removeClass("isStuck"),s(".stuckMenu").next().closest("div").css({"margin-top":p+"px"},10),s(".stuckMenu").css("position","relative"))})})});
!function(){"use strict"}(),jQuery(function(o){var t=[self.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft,self.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop];(setNavbar=function(){o(".navbar ul>li").css("width",o(".content").width()/3-2+"px")})(),o(document).ready(function(){o(".navbar-wrapper").stickUp(),setNavbar()}),o(window).resize(function(){setNavbar()}),o(".modal-event").on("click",function(){o(".modal-img").attr("src",o(this).attr("src")),t=[self.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft,self.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop],o(".masthead").css("opacity",0),o(".row").css("opacity",0),o(".nav").css("opacity",0),o(".modal-img").css("maxHeight",document.documentElement.clientHeight+"px"),o("html").css("position","fixed"),o(".modal-close").css("zIndex","9999"),o(".modal-img").css("opacity",1)}),o(".modal-close").on("click",function(){o("html").css("position","relative"),window.scrollTo(t[0],t[1]),o("body").css("opacity",1),o(".masthead").css("opacity",1),o(".row").css("opacity",1),o(".nav").css("opacity",1),o(".modal-img").css("opacity",0),closeModal()}),o(document).ready(function(){function t(){c.parallax("50%",1)}o(window).bind("load",function(){t()});var c=jQuery(".masthead");t()})});
window.Barekit={autoInitialize:!0},function(t,o){var s=function(){this.init.apply(this,arguments)};s.defaults={className:"accordion",multiExpand:!1,panelSelector:"dd",triggerSelector:"dt a",activeTrigger:"accordion-trigger--open",activePanel:"accordion-panel--open"},s.prototype.init=function(t,a){this.$el=o(t),this.options=o.extend({},s.defaults,a,this.$el.data("options")),this.$el.addClass(this.options.className),this.$el.on("click.bk.accordion",o.proxy(this.onClick,this))},s.prototype.onClick=function(t){var s=o(t.target);if(s.is("a")){t.preventDefault();var a=s.parent().next("dd");this.processOptions(s,a)}},s.prototype.processOptions=function(t,o){var s=this.$el.find(this.options.panelSelector),a=this.$el.find(this.options.triggerSelector),i=this.options.activeTrigger,n=this.options.activePanel;this.options.multiExpand===!0?(t.parent().toggleClass(i),o.toggleClass(n)):(a.parent().removeClass(i),t.parent().addClass(i),o.hasClass(n)||s.removeClass(n),o.toggleClass(n))},s.prototype.destroy=function(){this.$el.off(".accordion")},t.Accordion=s,o.fn.bkAccordion=function(t){return this.each(function(){var a=o(this);a.data("bkAccordion")||a.data("bkAccordion",new s(this,t))})},o.fn.bkAccordion.defaults=s.defaults,jQuery(function(o){t.autoInitialize&&o("."+s.defaults.className).bkAccordion()})}(Barekit,jQuery),function(t,o){var s=function(){this.init.apply(this,arguments)};s.defaults={className:"dropdown-nav",click:!0,clickClass:"click-setting",activeTrigger:"dropdown-trigger--open",activeClass:"dropdown--open"},s.prototype.init=function(t,a){this.$el=o(t);var i=this.$el.find("li:has(ul) > a");this.options=o.extend({},s.defaults,a,this.$el.data("options")),this.$el.addClass(this.options.className),1==this.options.click&&(i.on("mouseover.bk.dropdown",o.proxy(this.add,this)),i.on("click.bk.dropdown",o.proxy(this.remove,this)))},s.prototype.add=function(t){var s=o(t.target);s.parent().addClass(this.options.clickClass)},s.prototype.remove=function(t){var s=o(t.target),a=s.siblings("ul");t.preventDefault(),s.parent().removeClass(this.options.className),this.doDropdown(s,a)},s.prototype.doDropdown=function(t,o){t.parent().toggleClass(this.options.activeTrigger),o.toggleClass(this.options.activeClass),t.parent().addClass(this.options.clickClass)},s.prototype.destroy=function(){this.$el.off(".dropdown")},t.Dropdown=s,o.fn.bkDropdown=function(t){return this.each(function(){var a=o(this);a.data("bkDropdown")||a.data("bkDropdown",new s(this,t))})},o.fn.bkDropdown.defaults=s.defaults,jQuery(function(o){t.autoInitialize&&o("."+s.defaults.className).bkDropdown()})}(Barekit,jQuery),function(t,o){var s=function(){this.init.apply(this,arguments)};s.defaults={className:"modal-trigger",modal:".modal",close:".modal-close",bg:"modal-bg",openClass:"modal-open"},s.prototype.init=function(t,a){var i=this;this.$el=o(t),this.options=o.extend({},s.defaults,a,this.$el.data("options")),this.$el.addClass(this.options.className),o(document).on("click.bk.modal",function(){i.closeModal()}).on("click.bk.modal","."+this.options.className,function(t){t.stopPropagation(),t.preventDefault(),i.onClick()}).on("click.bk.modal",this.options.modal,function(t){t.stopPropagation(),t.preventDefault()}).on("keyup.bk.modal",function(t){27===t.keyCode&&i.closeModal()}),o(this.options.close).on("click.bk.modal",function(){i.closeModal()})},s.prototype.onClick=function(){var t=o("#"+this.options.modalId);this.openModal(t)},s.prototype.openModal=function(t){$(".masthead").css("opacity",0),$(".row").css("opacity",0),$(".nav").css("opacity",0),$("html").css("position","fixed"),$(".modal-close").css("zIndex","9999"),$(".modal-img").css("opacity",1),o("body").addClass(this.options.bg),t.addClass(this.options.openClass)},s.prototype.closeModal=function(){$("html").css("position","relative"),$("body").css("opacity",1),$(".masthead").css("opacity",1),$(".row").css("opacity",1),$(".nav").css("opacity",1),$(".modal-img").css("opacity",0),o("body").removeClass(this.options.bg),o(this.options.modal).removeClass(this.options.openClass)},s.prototype.destroy=function(){o(document).off(".modal"),o(this.options.close).off(".modal")},t.Modal=s,o.fn.bkModal=function(t){return this.each(function(){var a=o(this);a.data("bkModal")||a.data("bkModal",new s(this,t))})},o.fn.bkModal.defaults=s.defaults,jQuery(function(o){t.autoInitialize&&o("."+s.defaults.className).bkModal()})}(Barekit,jQuery),function(t,o){var s=function(){this.init.apply(this,arguments)};s.defaults={className:"off-canvas-contain",trigger:".off-canvas-trigger",offCanvasContent:".off-canvas",openClass:"off-canvas--open"},s.prototype.init=function(t,a){var i=this;this.$el=o(t);var a=this.options=o.extend({},s.defaults,a,this.$el.data("options"));this.$el.addClass(a.className),o(document).on("click.bk.offcanvas",function(){i.closeOffCanvas()}).on("click.bk.offcanvas",a.trigger,function(t){var s=o(this),n=s.parents(".off-canvas-contain");t.stopPropagation(),t.preventDefault(),n.hasClass(a.openClass)?i.closeOffCanvas():i.openOffCanvas(s,n)}).on("click.bk.offcanvas",a.offCanvasContent,function(t){t.stopPropagation()})},s.prototype.closeOffCanvas=function(){this.$el.removeClass(this.options.openClass)},s.prototype.openOffCanvas=function(t,o){o.addClass(this.options.openClass)},s.prototype.destroy=function(){o(document).off(".offcanvas")},t.OffCanvas=s,o.fn.bkOffCanvas=function(t){return this.each(function(){var a=o(this);a.data("bkOffCanvas")||a.data("bkOffCanvas",new s(this,t))})},o.fn.bkOffCanvas.defaults=s.defaults,jQuery(function(o){t.autoInitialize&&o("."+s.defaults.className).bkOffCanvas()})}(Barekit,jQuery),function(t,o){var s=function(){this.init.apply(this,arguments)};s.defaults={className:"tabs",panelClass:"tabs-panels",activeTrigger:"tab-trigger--open",activePanel:"tab-panel--open"},s.prototype.init=function(t,a){var i=this;this.$el=o(t),this.options=o.extend({},s.defaults,a,this.$el.data("options")),this.$el.addClass(this.options.className),this.$trigger=this.$el.find("li a"),this.$trigger.on("click.bk.tabs",function(t){var s=o(this);t.preventDefault(),i.doTabs(s)})},s.prototype.doTabs=function(t){var o=t.parent().parent().next("."+this.options.panelClass),s=o.children("li"),a=t.parent().index(),i=s.eq(a);this.$trigger.parent().removeClass(this.options.activeTrigger),t.parent().addClass(this.options.activeTrigger),s.removeClass(this.options.activePanel),i.addClass(this.options.activePanel)},s.prototype.destroy=function(){this.$trigger.off(".tabs")},t.Tabs=s,o.fn.bkTabs=function(t){return this.each(function(){var a=o(this);a.data("bkTabs")||a.data("bkTabs",new s(this,t))})},o.fn.bkTabs.defaults=s.defaults,jQuery(function(o){t.autoInitialize&&o("."+s.defaults.className).bkTabs()})}(Barekit,jQuery),function(t,o){var s=function(){this.init.apply(this,arguments)};s.defaults={className:"toggle-trigger",toggle:"",activeClass:"toggle-shown"},s.prototype.init=function(t,a){var i=this;this.$el=o(t),this.options=o.extend({},s.defaults,a,this.$el.data("options")),this.$el.addClass(this.options.className),this.$el.on("click.bk.toggle",function(t){o(this),t.preventDefault(),i.doToggle()})},s.prototype.doToggle=function(){var t=o("#"+this.options.toggle);t.toggleClass(this.options.activeClass)},s.prototype.destroy=function(){this.$el.off(".toggle")},t.Toggle=s,o.fn.bkToggle=function(t){return this.each(function(){var a=o(this);a.data("bkToggle")||a.data("bkToggle",new s(this,t))})},o.fn.bkToggle.defaults=s.defaults,jQuery(function(o){t.autoInitialize&&o("."+s.defaults.className).bkToggle()})}(Barekit,jQuery);
