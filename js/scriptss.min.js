...
!function(){"use strict"}(),jQuery(function(n){function a(){t.parallax("50%",1)}(setNavbar=function(){n(".navbar ul>li").css("width",n(".content").width()/3-2+"px")})(),n(document).ready(function(){n(".navbar-wrapper").stickUp(),setNavbar()}),n(window).resize(function(){setNavbar()}),n(window).bind("load",function(){a()});var t=jQuery(".masthead");a()});
